class ISAApp {
    ...
    renderLogin() {
        return `
            <div class="login-container">
                <div class="login-box">
                    <h2 class="login-title">Sistema ISA</h2>
                    <form id="login-form">
                        ...
                        <tbody>
                            ${data.map(eval => `
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm" onclick="app.viewEvaluation(${eval.id})">Ver</button>
                                        <button class="btn btn-sm" onclick="app.editEvaluation(${eval.id})">Editar</button>
                                    </td>
                                </tr>
                            `).join('')}
                        </tbody>
    ...
    async loadAprobaciones() {
        const data = await this.apiRequest('/approvals/pending/');
        return `
            <div class="card">
                <div class="card-header">
